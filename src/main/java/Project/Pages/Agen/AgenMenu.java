 ...
 * @author dicky
 */
public class AgenMenu extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgenMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
