...
public class ProdukperKategori extends javax.swing.JInternalFrame {
    ...
    public ProdukperKategori(int idKategori, int index, String namaKategori) {
        // Simpan nilai ke variabel sebelum inisialisasi komponen
        this.identitasProduk = idKategori;
        this.indexProduk = index;
        this.jenisKategori = namaKategori;

        // Inisialisasi komponen GUI
        initComponents();

        // Set label setelah komponen diinisialisasi
        customFrame(jenisKategori);

        // Simpan instance halaman utama
        this.halamanUtama = Index.instance;

        // Debug
        System.out.println("ID: " + identitasProduk);
        System.out.println("Index: " + indexProduk);
        System.out.println("Nama: " + jenisKategori);
    ...
    private void customFrame(String jenisKategori) {
        labelNama.setText("Daftar Produk " + jenisKategori);
    }
    ...
    private void getData() {
        ...
        try {
            ...
            // Query produk berdasarkan idKategori (identitasProduk)
            ...
            stm.setInt(1, identitasProduk); // Pastikan variabel identitasProduk sudah di-set sebelumnya
            rs = stm.executeQuery();
    ...
    private void initComponents() {
        ...
        labelNama.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        labelNama.setText("Daftar Produk");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(14, 14, 14)
                .addComponent(labelNama, javax.swing.GroupLayout.PREFERRED_SIZE, 441, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(textNama, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE)
    ...
    private void btnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariActionPerformed
        ...
        try {
            ...
            String sql = "SELECT p.idProduk, p.namaProduk, k.namaKategori, p.hargaBeli, p.hargaJual, p.stok, p.created_at, p.updated_at " +
                         ...
                         "WHERE p.namaProduk LIKE ? AND p.idKategori = ? " +
                         "ORDER BY p.created_at DESC";

            Connection conn = (Connection) Connections.ConnectionDB();
            PreparedStatement pst = conn.prepareStatement(sql);
                pst.setString(1, "%" + keyword + "%");
                pst.setInt(2, identitasProduk);
