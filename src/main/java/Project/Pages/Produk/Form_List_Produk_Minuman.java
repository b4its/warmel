 ...
 * @author dicky
 */
public class Form_List_Produk_Minuman extends javax.swing.JFrame {

    /**
     * Creates new form Produk
     */
    public Form_List_Produk_Minuman() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Form List Produk Minuman");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_List_Produk_Minuman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_List_Produk_Minuman().setVisible(true);
            }
        });
    }
