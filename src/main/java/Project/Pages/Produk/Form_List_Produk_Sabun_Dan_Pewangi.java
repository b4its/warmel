 ...
 * @author dicky
 */
public class Form_List_Produk_Sabun_Dan_Pewangi extends javax.swing.JFrame {

    /**
     * Creates new form Produk
     */
    public Form_List_Produk_Sabun_Dan_Pewangi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Form List Produk Sabun dan Pewangi");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_List_Produk_Sabun_Dan_Pewangi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_List_Produk_Sabun_Dan_Pewangi().setVisible(true);
            }
        });
    }
